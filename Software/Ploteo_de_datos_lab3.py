...
archivo = "C:/Users/Equipo/OneDrive/Escritorio/Introduccion_a_señales_biomedicas/EMG_intro/Lectura_antebrazo_supinación_EMG.txt"
...
plt.title("Lectura del antebrazo supinación EMG en el dominio del tiempo")
plt.xlabel("Tiempo (s)")
